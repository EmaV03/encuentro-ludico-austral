...
//sección info de creadoras 
    creadoras: [
        { id: "crea-sv", nombre: "Sandra E. Vissani", rol: "Finanzas", foto: "Imagenes/creador1.png", bio: `
            <p>Master en Gamificacion y Narrativa transmedia</p>
            <p>Técnica Nac. en recreación</p>
            <p>Técnica ludotecaria con especialización en creación de juegos y juguetes</p>
            <p>Diplomada Univ. en creación de juegos de mesa</p>
            <p>Coach lúdica empresarial</p>
            `},
        { id: "crea-nj", nombre: "Natalia Jiménez", rol: "Presidenta", foto: "Imagenes/creador3.png", bio: `
            <p>Maestra especialista en educación infantil</p>
            <p>Máster en educación socio constructivista</p>
            <p>Guía montessori</p>
            ` },
        ...
        { id: "crea-ga", nombre: "Gabita", rol: "Comunicación", foto: "Imagenes/creador5.png", bio: `
            ...
            <p>Pakapaka y Deportv</p>
            `}
    ],
    expositores: [
        { id: "exp-or", nombre: "Oriol Ripoll <img src='https://upload.wikimedia.org/wikipedia/commons/c/ce/Flag_of_Catalonia.svg' style='width: 1.2em; height: auto; vertical-align: text-bottom; border-radius: 2px; box-shadow: 0 0 2px rgba(0,0,0,0.3); margin-left: 5px;' alt='Cataluña'>", avatar: "OR", titulo: "Magisterio especializado en juegos y didáctica", bio: "Cofundador del estudio 'Jocs al segon'. Profesor universitario de Game Design y director del Máster en Juego, Gamificación y Tecnología.", web: "", ponencia: "Sábado 10:30 - 12:00: Del juego al aprendizaje, cómo adaptar juegos al aula sin perder su magia.", materialUrl: "ponencia-oriol.pdf", tipoMaterial: "pdf"},
    ...
    sponsors: {
        principales: [ 
            ...
            { id: "sp-4", nombre: "Howard Johnson Bahía Blanca", logo: "Imagenes/Sponsor5.jpg", url: "https://www.hjbahiablanca.com.ar/" },
    ...
    editoriales: [
        ...
        { id: "ed-19", nombre: "Devir", logo: "Imagenes/editorial17.jpg", instagram: "https://www.instagram.com/devirargentina/", web: "https://devir.com.ar/", dondeEncontrar: "Disponibles para probar y comprar en nuestro stand durante todo el evento." }
    ],
    actividadesExtra: [
    ...
    cronograma: {
        dia1: {
            ...
            modulos: {
                manana: [
                    { id: "d1-m-1", titulo: "Ludificación de la enseñanza en Ciencias Sociales", ponente: "Ricardo Lema", aula: "Aula Rosa", resumen: "La Secuencia Aprendizaje Lúdico (SALú) aplicada a la enseñanza de contenidos de historia y literatura.", cupoMaximo: 20 },
                    { id: "d1-m-2", titulo: "La gran revolución: juego de rol masivo sobre economía, política y problemáticas sociales", ponente: "Franco Toffoli y Gabriel Ferraris", aula: "Aula Naranja", resumen: "Juego de rol masivo para aprender acerca del funcionamiento de la economía y la política de la Revolución Industrial. Juego y reflexión sobre la experiencia.", cupoMaximo: 20, materialUrl: "la-gran-revolucion-congreso-abj.pdf", tipoMaterial: "pdf"},
                    { id: "d1-m-3", titulo: "Juegos cooperativos no competitivos desde la neuroeducación", ponente: "Luciana Ballestero", aula: "Aula Roja", resumen: "Juegos cooperativos, juegos con propósitos pedagógicos y narrativas lúdicas como parte de la formación integral de las y los estudiantes", cupoMaximo: 20, materialUrl: "juegos-cooperativos-no-competitivos-desde-la-neuroeducacion.pdf", tipoMaterial: "pdf" },
                    { id: "d1-m-4", titulo: "Bienestar emocional: el juego como puente para aprender, sentir y crear", ponente: "Dayana Rubira", aula: "Aula Azul", resumen: "Herramientas y recursos para aplicar dinámicas lúdicas de estrategias de registro emocional y expresión creativa, fortalecer vínculos y trabajar la presencia, confianza y participación grupal.", cupoMaximo: 20 },
                    { id: "d1-m-5", titulo: "No es juego, es cerebro aprendiendo", ponente: "Natalia Felicetti", aula: "Aula Amarilla", resumen: "Se recuperarán aportes de la neurobiología para comprender por qué jugar puede activar procesos claves para aprender, crear, equivocarse, tomar decisiones y comprometerse con una tarea.", cupoMaximo: 20, materialUrl: "no-es-juego-es-cerebro-aprendiendo.pdf", tipoMaterial: "pdf"  },
                    { id: "d1-m-6", titulo: "Decidir para aprender: creación de aventuras point & click en contextos educativos", ponente: "Marisa Conde", aula: "Aula Verde", resumen: "Diseñar y prototipar una experiencia de juego serio tipo point & click que promueva el aprendizaje significativo mediante la toma de decisiones en contextos educativos. (TRAER COMPU)", cupoMaximo: 20, materialUrl: "decidir-para-aprender.pdf", tipoMaterial: "pdf" }
                ],
                tarde: [
        ...
        dia2: {
            ...
            modulos: {
                manana: [
                    { id: "d2-m-1", titulo: "Del juego al aprendizaje: laboratorio de adaptación para el aula", ponente: "Oriol Ripoll", aula: "Aula Amarilla", resumen: "Taller práctico donde partiremos de juegos conocidos. Los transformaremos a juegos para gran grupo, veremos todas las formas de adaptarlos a diferentes objetivos de aprendizaje para convertirlos en propuestas educativas reales.", cupoMaximo: 30 },
                    { id: "d2-m-2", titulo: "Experiencias de juegos y ABJ en la provincia de mendoza", ponente: "Emanuel Sánchez y Gianina Della Gaspera", aula: "Aula Rosa", resumen: "A partir de las experiencias y talleres desarrolladas en la provincia de Mendoza, construimos una guía práctica que sistematiza un recorrido paso a paso para el diseño, la implementación y el acompañamiento de esta metodología activa en diversas instituciones educativas, tanto formales como no formales.", cupoMaximo: 20 },
                    { id: "d2-m-3", titulo: " Juegos de educación ambiental", ponente: "Pepo Zamora", aula: "Aula Naranja", resumen: "Presentación de juegos de la editorial Compostate bien para presentar metodología y juegos de educación ambiental.", cupoMaximo: 20 },
                    { id: "d2-m-4", titulo: " Elige tu propia aventura: Donde las habilidades sociales y la ficción interactiva se encuentran", ponente: "Patricia Biaggiotti & Santiago Troncoso", aula: "Aula Roja", resumen: "Importancia de los procesos creativos en los espacios terapéuticos y en la inclusión educativa.", cupoMaximo: 10 },
                    { id: "d2-m-5", titulo: "Juegos en la secundaria", ponente: "Sandra Enrique", aula: "Aula Azul", resumen: "Ludotecas móviles para escuelas basadas en juegos de mesa modificados con enfoque de aprendizaje basado en juegos.", cupoMaximo: 20 },
                    { id: "d2-m-6", titulo: "Taller Su2ku", ponente: "Su2ku", aula: "Aula Verde", resumen: "El Su2ku es una adaptación del sudoku tradicional para convertilo en un juego de mesa para dos jugadores. A las características de deducción y memoria propias del tradicional solitario se le agrega el desafío de la competencia con oro jugador sobre el mismo tablero.", cupoMaximo: 10, materialUrl: "su2ku.pdf", tipoMaterial: "pdf" }
                ],
                tarde: [
                    { id: "d2-t-1", titulo: "Adolescencias en juego: experiencias de talleres lúdicos", ponente: "Alejandra Pytel & Solange Estevez", aula: "Aula Azul", resumen: "Taller experiencial para comprender la dimensionalidad de la comunicación intergeneracional, experiencia del juego como generador de la palabra en espacios reales de interacción. Se invita a los participantes a vivir el juego, como la narrativa necesaria para la construcción adolescente", cupoMaximo: 30 },
                    { id: "d2-t-2", titulo: "Juegos que se tocan: Aprendizaje basado en Juegos con Scratch y Chimeleta", ponente: "Andrea Rocca", aula: "Aula Naranja", resumen: "Este taller propone dar un paso más: crear juegos que se puedan tocar, intervenir y experimentar físicamente. A partir de la integración de Scratch y Chimeleta, se explorarán propuestas de aprendizaje basado en juegos que combinan programación, interacción tangible y enfoque maker. (TRAER COMPU)", cupoMaximo: 20, materialUrl: "juegos-que-se-tocan.pdf", tipoMaterial: "pdf" },
                    { id: "d2-t-3", titulo: "Juegos nómadas del mundo", ponente: "Ricardo Acuña", aula: "Aula Verde", resumen: "Un viaje para compartir con los pueblos túrquicos sus milenarias propuestas lúdicas tales como Bestemshé, Toguzqumalaq, Mangala, Assyk atu nos acerca a esta fascinante parte de nuestro planeta, con juegos abstractos de tablero lúdicos y competitivos a la vez.", cupoMaximo: 20 },
                    { id: "d2-t-4", titulo: "Jugar a las matemáticas", ponente: "Ángela Vázquez ,Gabriela Esquivel y Evangelina Pinilla", aula: "Aula Amarilla", resumen: "Vivenciar situaciones, a partir de juegos de mesa, que permitan reconocer los contenidos matemáticos presentes en ellos y sus alcances dentro del Nivel Primario.", cupoMaximo: 20 },
                    { id: "d2-t-5", titulo: "Explora, aprende y disfruta con la colección de juegos expedición, diseñados para sumergirte en la diversidad de la naturaleza Argentina", ponente: "Editorial Tekun", aula: "Aula Rosa", resumen: "Probar juegos de la editorial Tekun centrados en la educación ambiental y reflexionar acerca de la promoción ambiental y los beneficios de utilizar juegos con finalidades educativas.", cupoMaximo: 20 },
                    { id: "d2-t-6", titulo: "Escape rooms educativos", ponente: "Fabian Zamit", aula: "Aula Roja", resumen: "El taller pretende acercar a las y los participantes una introducción a las habilidades prácticas y los recursos necesarios para diseñar sus propios Escape Rooms educativos. Conoceremos porque estás experiencias lúdicas, caracterizadas por un contexto delimitado y un objetivo determinado, constituyen un excelente ejemplo de aprendizaje basado en juegos.", cupoMaximo: 20, materialUrl: "escape-room-en-el-aula.pdf", tipoMaterial: "pdf" }
                ]
            }
        },
        dia3: {
            ...
            modulos: {
                manana: [
                    { id: "d3-m-1", titulo: "Resonancia Lúdica, metodología para el diseño de experiencias de ABJ", ponente: "Fernando Ortiz", aula: "Aula verde - auditorio", resumen: "Ruta estructurada  para convertir una necesidad educativa en una experiencia de ABJ, proporcionando un marco de diseño que permita a docentes, formadores y diseñadores educativos construir propuestas coherentes, significativas y transferibles a diversos contextos de formación.", cupoMaximo: 30 },
                    { id: "d3-m-2", titulo: "Juegos de bazas", ponente: "Fabian Martinez", aula: "Aula violeta - Zona de Stands", resumen: "Las bazas son una mecánica muy popular y un ecosistema perfecto para entrenar habilidades cognitivas, matemáticas, estratégicas y sociales de forma muy orgánica. Pero, ¿Cómo evolucionaron? ¿Qué hago? ¿Cómo la uso? ¿Realmente sirven?", cupoMaximo: 20, materialUrl: "juegos-de-bazas.pdf", tipoMaterial: "pdf" },
                    { id: "d3-m-3", titulo: "Scrabble para el aula", ponente: "Luis Osvaldo Carestia", aula: "Aula Naranja", resumen: "Scrabble como herramienta de enseñanza integral más allá del lenguaje.", cupoMaximo: 15, materialUrl: "scrabble.pdf", tipoMaterial: "pdf" },
                    { id: "d3-m-4", titulo: "Enseñar ciencia a través del juego: propuestas experimentales para diferentes contextos y niveles educativos", ponente: "Juliana Bambozzi", aula: "Aula Roja", resumen: "Experiencias gamificadas para la enseñanza de ciencias, reflexionando acerca de su potencial para promover la alfabetización científica en diferentes niveles y contextos educativos.", cupoMaximo: 15 },
                    { id: "d3-m-5", titulo: "El diseño del aula. Experiencias de un trayecto de formación docente en ABJ", ponente: "Instituto Don Bosco Rosario", aula: "Aula Azul", resumen: "Docentes en formación presentan los juegos que diseñaron y adaptaron durante un trayecto de Aprendizaje Basado en Juego para implementar en sus aulas. Las propuestas abarcan distintos niveles y edades . Cada grupo cuenta su objetivo pedagógico y su proceso de diseño, y los participantes del taller juegan y testean los prototipos en vivo.", cupoMaximo: 20, materialUrl: "el-diseno-del-aula.pdf", tipoMaterial: "pdf" },
                    { id: "d3-m-6", titulo: "Invitar a jugar, una experiencia práctica con personas mayores", ponente: "Solange Estevez & Alejandra Pytel", aula: "Aula Amarilla", resumen: "Eje Temático: Familia.", cupoMaximo: 20 },
                    { id: "d3-m-7", titulo: "La magia al servicio del aula, juegos hipotéticos deductivos", ponente: "Lautaro Lopes", aula: "Aula violeta - Zona de Stands", resumen: "Recursos didácticos, algunos basados en juegos de magia, que permiten explorar el método científico para la deducción del \"detrás de la magia\".", cupoMaximo: 20 }
                ],
                tarde: [] 
            }
        }
