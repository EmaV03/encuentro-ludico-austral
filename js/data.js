export const congresoData = {
    ...
    cronograma: {
        dia1: {
            ...
            modulos: {
                manana: [
                    ...
                    { id: "d1-m-5", titulo: "No es juego, es cerebro aprendiendo", ponente: "Natalia Felicetti", aula: "Aula Rosa", resumen: "Se recuperarán aportes de la neurobiología para comprender por qué jugar puede activar procesos claves para aprender, crear, equivocarse, tomar decisiones y comprometerse con una tarea.", cupoMaximo: 20 },
        ...
        dia2: {
            ...
            modulos: {
                manana: [
                    ...
                    { id: "d2-m-2", titulo: "El juego como gran enlazador de contenidos", ponente: "Marisa Torres", aula: "Aula Azul", resumen: "Herramientas y voluntades para implementar el juego en el aula", cupoMaximo: 5 },
                    ...
                    { id: "d2-m-4", titulo: " Juegos de educación ambiental", ponente: "Pepo Zamora", aula: "Aula Naranja", resumen: "Presentación de juegos de la editorial Compostate bien para presentar metodología y juegos de educación ambiental.", cupoMaximo: 20 },
                    { id: "d2-m-5", titulo: " Elige tu propia aventura: Donde las habilidades sociales y la ficción interactiva se encuentran", ponente: "Patricia Biaggiotti & Santiago Troncoso", aula: "Aula Roja", resumen: "Importancia de los procesos creativos en los espacios terapéuticos y en la inclusión educativa.", cupoMaximo: 10 },
                    { id: "d2-m-6", titulo: "Juegos en la secundaria", ponente: "Sandra Enrique", aula: "Aula Azul", resumen: "Ludotecas móviles para escuelas basadas en juegos de mesa modificados con enfoque de aprendizaje basado en juegos.", cupoMaximo: 20 },
                    { id: "d2-m-7", titulo: "Taller Su2ku", ponente: "Su2ku", aula: "Aula Verde", resumen: "El Su2ku es una adaptación del sudoku tradicional para convertilo en un juego de mesa para dos jugadores. A las características de deducción y memoria propias del tradicional solitario se le agrega el desafío de la competencia con oro jugador sobre el mismo tablero.", cupoMaximo: 10 }
                ],
                tarde: [
        ...
        dia3: {
            ...
            modulos: {
                manana: [
                    { id: "d3-m-1", titulo: "Resonancia Lúdica, metodología para el diseño de experiencias de ABJ", ponente: "Fernando Ortiz", aula: "Aula Roja", resumen: "Ruta estructurada  para convertir una necesidad educativa en una experiencia de ABJ, proporcionando un marco de diseño que permita a docentes, formadores y diseñadores educativos construir propuestas coherentes, significativas y transferibles a diversos contextos de formación.", cupoMaximo: 30 },
                    { id: "d3-m-2", titulo: "Juegos de bazas", ponente: "Fabian Martinez", aula: "Aula Rosa", resumen: "Las bazas son una mecánica muy popular y un ecosistema perfecto para entrenar habilidades cognitivas, matemáticas, estratégicas y sociales de forma muy orgánica. Pero, ¿Cómo evolucionaron? ¿Qué hago? ¿Cómo la uso? ¿Realmente sirven?", cupoMaximo: 20 },
                    ...
                    { id: "d3-m-7", titulo: "La magia al servicio del aula, juegos hipotéticos deductivos", ponente: "Lautaro Lopes", aula: "Aula Violeta", resumen: "Recursos didácticos, algunos basados en juegos de magia, que permiten explorar el método científico para la deducción del \"detrás de la magia\".", cupoMaximo: 20 }
                ],
                tarde: [] 
            }
        }
