export const congresoData = {
    ...
    cronograma: {
        dia1: {
            ...
            modulos: {
                manana: [
                    { id: "d1-m-1", titulo: "Ludificación de la enseñanza en Ciencias Sociales", ponente: "Ricardo Lema", aula: "Aula Amarilla", resumen: "La Secuencia Aprendizaje Lúdico (SALú) aplicada a la enseñanza de contenidos de historia y literatura.", cupoMaximo: 30 },
                    { id: "d1-m-2", titulo: "La gran revolución", ponente: "Franco Toffoli y Gabriel Ferraris", aula: "Aula Naranja", resumen: "Juego de rol masivo para aprender acerca del funcionamiento de la economía y la política de la Revolución Industrial. Juego y reflexión sobre la experiencia.", cupoMaximo: 30 },
                    ...
                    { id: "d1-m-4", titulo: "Bienestar emocional: el juego como puente para aprender, sentir y crear", ponente: "Dayana Rubira", aula: "Aula Verde", resumen: "Herramientas y recursos para aplicar dinámicas lúdicas de estrategias de registro emocional y expresión creativa, fortalecer vínculos y trabajar la presencia, confianza y participación grupal.", cupoMaximo: 20 },
                    { id: "d1-m-5", titulo: "No es juego, es cerebro aprendiendo", ponente: "Natalia Felicetti", aula: "Aula Violeta", resumen: "Se recuperarán aportes de la neurobiología para comprender por qué jugar puede activar procesos claves para aprender, crear, equivocarse, tomar decisiones y comprometerse con una tarea.", cupoMaximo: 20 },
                    { id: "d1-m-6", titulo: "Decidir para aprender: creación de aventuras point & click en contextos educativos", ponente: "Marisa Conde", aula: "Aula Azul", resumen: "Diseñar y prototipar una experiencia de juego serio tipo point & click que promueva el aprendizaje significativo mediante la toma de decisiones en contextos educativos. (TRAER COMPU)", cupoMaximo: 20 }
                ],
                tarde: [
                    { id: "d1-t-1", titulo: "Los juegos y sus posibilidades desde una mirada editorial", ponente: "Dragón Azul y Su2ku", aula: "Aula Violeta", resumen: "El encuentro propone un formato de conversatorio activo que combina el testeo directo de los juegos con la reflexión compartida sobre experiencias de implementación.", cupoMaximo: 20 },
                    { id: "d1-t-2", titulo: "Colorido Juegos su aplicación a contextos educativos", ponente: "Micaela Koncurat", aula: "Aula Amarilla", resumen: "Los participantes experimentarán los juegos de la editorial Colorido y se reflexionará sobre sus posibles aplicaciones según objetivos de aprendizaje y edades.", cupoMaximo: 20 },
                    ...
                    { id: "d1-t-4", titulo: "QuoriDUA: Caminos para Aprender Jugando", ponente: "Liliana Mendez", aula: "Aula Rosa", resumen: "Identificar barreras para enseñar y aprender, diseño universal de aprendizaje y juego. Quoridor inclusivo, reversionando las prácticas.", cupoMaximo: 20 },
                    ...
                    { id: "d1-t-7", titulo: "ABJ desde la enseñanza oficial", ponente: "Instituto Yuguets", aula: "Aula Verde", resumen: "Charla acerca de la formación terciaria en ludotecario, creación de juegos y juguetes. Presentación del juego culturas originarias.", cupoMaximo: 20 }
                ]
            }
        },
        dia2: {
            ...
            modulos: {
                manana: [
                    ...
                    { id: "d2-m-2", titulo: "El juego como gran enlazador de contenidos", ponente: "Marisa Torres", aula: "Aula Azul", resumen: "Herramientas y voluntades para implementar el juego en el aula", cupoMaximo: 20 },
                    ...
                    { id: "d2-m-5", titulo: " Elige tu propia aventura: Donde las habilidades sociales y la ficción interactiva se encuentran", ponente: "Patricia Biagiotti", aula: "Aula Roja", resumen: "Importancia de los procesos creativos en los espacios terapéuticos y en la inclusión educativa.", cupoMaximo: 20 },
                    { id: "d2-m-6", titulo: "Juegos en la secundaria", ponente: "Sandra Enrique", aula: "Aula Violeta", resumen: "Ludotecas móviles para escuelas basadas en juegos de mesa modificados con enfoque de aprendizaje basado en juegos.", cupoMaximo: 20 },
                    { id: "d2-m-7", titulo: "Juegos para actuar", ponente: "Damián Valgiusti", aula: "Aula Verde", resumen: "Metodología Kabuki,comprendiendo como el juego y el teatro pueden convertirse en herramientas para la enseñanza", cupoMaximo: 20 }
                ],
                tarde: [
                    ...
                    { id: "d2-t-6", titulo: "De 0 a 99 años, proyectos de Homo Ludens", ponente: "Equipo de Homo Ludens", aula: "Aula Violeta", resumen: "Experiencias del juego en distintos ámbitos tales cómo, la tercera edad, en el mundo empresarial, en las escuelas, bibliotecas y demás.", cupoMaximo: 20 },
                    { id: "d2-t-7", titulo: "Escape rooms educativos", ponente: "Fabian Zamit", aula: "Aula Roja", resumen: "El taller pretende acercar a las y los participantes una introducción a las habilidades prácticas y los recursos necesarios para diseñar sus propios Escape Rooms educativos. Conoceremos porque estás experiencias lúdicas, caracterizadas por un contexto delimitado y un objetivo determinado, constituyen un excelente ejemplo de aprendizaje basado en juegos.", cupoMaximo: 20 }
                ]
            }
        },
        dia3: {
